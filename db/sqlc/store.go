...
type Store interface {
	Querier
	TrasferTx(ctx context.Context, arg TransferTxParams) (result TransferTxResult, err error)
}
...
func (store *SQLStore) TrasferTx(ctx context.Context, arg TransferTxParams) (result TransferTxResult, err error) {
...
// addMoney manipulation of balance the accounts
func addMoney(
	ctx context.Context,
	q *Queries,
	accountID1 int64,
